...
var _Launch = __webpack_require__(33);
...
var _CardForm = __webpack_require__(34);
...
var Launch = exports.Launch = function (_Component) {
    ...
    _createClass(Launch, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_CardForm.CardForm, null);
        }
    }]);
...
var _CardInput = __webpack_require__(35);
...
var CardForm = exports.CardForm = function (_Component) {
    ...
    _createClass(CardForm, [{
            ...
            if (this.state.submitted) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'container' },
                        _react2.default.createElement(_CardInput.CardInput, {
                            type: 'name',
                            value: function value(data, id) {
                                return _this2.getValue(data, id);
                            }
                        }),
                        _react2.default.createElement(_CardInput.CardInput, {
                            type: 'cardNumber',
        ...
        key: 'getValue',
        value: function getValue(data, id) {
            this.setState(_defineProperty({}, id, data));
        }
    }]);
...
var CardInput = exports.CardInput = function (_Component) {
    ...
    _createClass(CardInput, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('input', {
                ...
                onChange: function onChange() {
                    return _this2.logValueChange(_this2.props.type);
                },
        ...
        key: 'logValueChange',
        value: function logValueChange(id) {
            ...
            this.setState(_defineProperty({}, id, _extends({}, this.state[id], { val: val })));
        ...
        value: function determineType(type) {
            var qualities = CardInput.typeMap[type];
            this.setState(_defineProperty({}, type, qualities));
        }
    }, {
        key: 'value',
        value: function value(val, id) {
